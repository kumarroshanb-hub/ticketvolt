...
class EmailTicketService:
    ...
    # In email_service.py - Update the send_ticket_email method
    @staticmethod
    def send_ticket_email(booking):
        ...
        try:
            ...
            qr_data = {
                ...
                'code': first_ticket.unique_code,
                'event': booking.event.title,
                'attendee': booking.customer_name
            }
            qr.add_data(str(qr_data))
            qr.make(fit=True)
            img = qr.make_image(fill_color="black", back_color="white")
            ...
            # Set the QR code on the ticket object for template
